...
Panel {
  ...
  // Round-trip pings feed the latency chart and stats refresh while open.
  Timer {
    interval: 1000
    repeat: true
  ...
  PopupCard {
    ...
    // Taller than the screen on small displays: scroll inside the card.
    Flickable {
      anchors.fill: parent
      contentWidth: width
    ...
    Column {
      ...
      Column {
        ...
        SectionLabel { text: "KEYBOARD VOLUME"; rightText: (root.service ? root.service.volume : 0) + "%" }
        PanelSlider {
      ...
      Column {
        ...
        Switch {
          title: "Velocity"; subtitle: "louder when you type fast"
          checked: root.service ? root.service.velocity : false
          onToggled: if (root.service) root.service.setVelocity(!root.service.velocity)
        }
        Switch {
          title: "Release sounds"; subtitle: "quiet key-up sample"
          checked: root.service ? root.service.releaseSounds : false
          onToggled: if (root.service) root.service.setReleaseSounds(!root.service.releaseSounds)
        }
        Flow {
          width: parent.width
          spacing: Style.space(5)
      ...
      Column {
        ...
        Column {
          ...
          Column {
            width: parent.width
            spacing: Style.space(4)
            SectionLabel { text: "MOUSE VOLUME"; rightText: (root.service ? root.service.mouseVolume : 0) + "%" }
            PanelSlider {
              bar: root.bar; width: parent.width; minimum: 0; maximum: 100; step: 1; integer: true
      ...
      Column {
        ...
        Row {
          width: parent.width
          spacing: Style.space(10)
          // Rhythm: inter-key intervals in 60 ms buckets, last five minutes.
          Row {
            id: rhythm
          ...
          Column {
            ...
            Text {
              ...
              color: root.dimFg; font.family: root.mono; font.pixelSize: Style.font.caption
              width: column.width - rhythm.width - Style.space(10); elide: Text.ElideRight
            }
          }
        }
      }
